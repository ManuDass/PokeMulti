...
**Mac preview:** [Apple Silicon (.dmg)](https://github.com/ManuDass/PokeMulti/releases/download/v0.27.3-mac-preview/PokeMulti-0.27.3-macOS-arm64.dmg) · [Intel (.dmg)](https://github.com/ManuDass/PokeMulti/releases/download/v0.27.3-mac-preview/PokeMulti-0.27.3-macOS-x86_64.dmg)
...
[Mac preview notes](https://github.com/ManuDass/PokeMulti/releases/tag/v0.27.3-mac-preview)
...
**0.26.8 · FRMP 23 · experimental.** FireRed US 1.0 and LeafGreen US 1.1
