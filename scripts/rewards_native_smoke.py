...
root=Path(__file__).resolve().parents[1];base=Path(a.reuse) if a.reuse else root/'cache'/('rewards-native-'+a.case+'-'+uuid.uuid4().hex);base.mkdir(exist_ok=True);runs=[];seq=10
